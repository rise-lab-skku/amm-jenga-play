    ...
    try:
        ...
        while True:
            ...
            #jenga playing functions
                ...
                move.go_to_pose_goal(get_quaternion_from_euler(1.57, 1.57, 1.57), [0.373,-0.4,0.196])
                time.sleep(1)
                grasp_client(0.072)
                time.sleep(1)
                ...
                time.sleep(1)
                move_client(0)
                move.go_to_pose_goal(get_quaternion_from_euler(1.57, 1.57, 1.57), [0.36,-0.4,0.124])
                time.sleep(1)
